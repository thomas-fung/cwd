...
- making an Rmd document that can be compiled to a variety of output formats
- making a book using `bookdown`


## `r emo::ji("wrench")` Preparation  

   
1. Download ``tutorial-01-suppA.Rmd`, `tutorial-01-suppB.Rmd` and `tutorial-01-suppC.Rmd` from the [course home page](https://cwd.numbat.space/).
...
3. [Replace the data below with information of people you met in this tutorial.]{.question} (You should get data of a minium of 3 people).
