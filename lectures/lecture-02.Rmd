...
`r seetext` <span style="font-size:18pt;">`<span style="color:blue;">Author content</span>`</span><br>
...
`r seetext` <span style="font-size:18pt;">`<img height="40px" src="https://tinyurl.com/rlogo-svg">`</span><br>
